    ...
    <div className="pomodoro-form">
      <div className='pm-form-left-block'>
        ...
        <div className='pm-input-container'>
          <div className='pm-inputs-container-top'>
            <div className='pm-inputs-container-top-left'>
              <div className='pm-inputs-group'>
                <label className='pm-label pm-label-createselect'>Timer name</label>
            ...
            <div className='pm-inputs-container-top-right'>
              <div className='pm-inputs-group'>
              ...
              <div className='pm-inputs-group pm-input-break'>
                <label className='pm-label'>Shortbreak</label>
                <StepInputTimer
                  disabled={props.disabled}
                  name='short_break'
              ...
              <div className='pm-inputs-group'>
                <label className='pm-label'>Repeats</label>
                <StepInputInt 
                  disabled={props.disabled}
                  name='cycles'
              ...
              <div className='pm-inputs-group pm-input-break'>
                <label className='pm-label'>Longbreak</label>
                <StepInputTimer 
                  disabled={props.disabled}
                  name='long_break'
          ...
          <div className='pm-inputs-container-bottom'>

            <div className='pm-inputs-container-bottom-left'>
              <div className='pm-inputs-container-bottom-left pm-inputs-alerts'>
                <div className='pm-inputs-group'>
                  <label className='pm-label pm-label-createselect'></label>
            ...
            <div className='pm-inputs-container-bottom-right'>
              <div className='pm-alerts-group'>
                <label className='pm-label'>Shortbreak START</label>
                <select 
                  disabled={props.disabled}
              ...
              <div className='pm-alerts-group'>
                <label className='pm-label'>Shortbreak END</label>
                <select 
                  disabled={props.disabled}
              ...
              <div className='pm-alerts-group'>
                <label className='pm-label'>Longbreak START</label>
                <select 
                  disabled={props.disabled}
              ...
              <div className='pm-alerts-group'>
                <label className='pm-label'>Longbreak END</label>
                <select 
                  disabled={props.disabled}
      ...
      <div className='pm-form-right-block'>
        <div className='pm-calc-times'>
          <div>
            <label className='pm-label'>Total Duration</label>
            <StepInputTimer disabled 
              value={stats.duration}
            />
          </div>
          <div>
            <label className='pm-label'>Total Work</label>
            <StepInputTimer disabled 
              value={stats.work}
            />
          </div>
